					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form action="<?php echo site_url('store/tim_san_pham')?>" method="get" enctype="multipart/form-data">
										...
										<div class="cart-list">
											<div class="product-widget">
												<div class="product-img">
													<img src="<?php echo public_url()?>site/img/product01.png" alt="">
												</div>
											...
											<div class="product-widget">
												<div class="product-img">
													<img src="<?php echo public_url()?>site/img/product02.png" alt="">
												</div>
												<div class="product-body">
													<h3 class="product-name"><a href="#">product name goes here</a></h3>

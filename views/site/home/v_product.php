				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name"><?php echo $value['tensp'];?></h2>
							<div>
								...
								<a class="review-link" href="#">10 Review(s) | Đánh giá</a>
							</div>
							<div>
								<h3 class="product-price"><?php giamoi($value['gia'],$value['khuyenmai']);?> VNĐ <del class="product-old-price"><?php dinhdangso($value['gia']);?></del></h3>
